...
import classes from './PassageTypeQuestion.css';
...
const submissionTypeQuestion = (props) => {
    ...
    <Row>
        ...
        <Input elementType="input" elementLabel="Ideal Answer:" changed={props.IdealAnswer} elementPlaceholder="Type your answer here ..."/>
